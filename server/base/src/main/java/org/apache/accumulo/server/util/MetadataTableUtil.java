...
public class MetadataTableUtil {
  ...
  public static void createReplicationTable(Instance instance, SystemCredentials systemCredentials) throws IOException {
    //NOT SURE IF THIS IS THE TABLE_ID TO USE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    String dir = VolumeManagerImpl.get().choose(Optional.of(MetadataTable.ID), ServerConstants.getBaseUris()) + Constants.HDFS_TABLES_DIR + Path.SEPARATOR + ReplicationTable.ID
