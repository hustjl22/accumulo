...
class ChooseDir extends MasterRepo {
  ...
  public Repo<Master> call(long tid, Master master) throws Exception {
    ...
    tableInfo.dir = master.getFileSystem().choose(Optional.of(tableInfo.tableId), ServerConstants.getBaseUris()) + "/tables/" + tableInfo.tableId + Constants.DEFAULT_TABLET_LOCATION;
