  ...
  private void deleteTablets(MergeInfo info) throws AccumuloException {
    ...
    try {
      ...
      if (followingTablet != null) {
        ...
        String tdir = master.getFileSystem().choose(Optional.of(extent.getTableId().toString()), ServerConstants.getBaseUris()) + "/tables/" + extent.getTableId() + Constants.DEFAULT_TABLET_LOCATION;
